...
const s_stylePath = '/1stylescripts/comment-widget-dark.css';
const s_formId = '1FAIpQLSd23u0-FDyuNZSuHMj8h0_GzTlifkt4bgm5Wq5SvLIq0K0RSQ';
const s_nameId = '972344146';
const s_websiteId = '856090312';
const s_textId = '1465307776';
const s_pageId = '1887908811';
const s_replyId = '899236361';
const s_sheetId = '1dP9VNHsggHNMVVUMWg7iQlQt7EIvcPNgewxYf_Y1loU';
...
const s_filteredWords = [ // Add words to filter by putting them in quotes and separating with commas (ie. 'heck', 'dang')
    'nigga', 'gook', 'retard', 'faggot', 'tranny', 'nigger', 'theyfab'
]
...
const zebra = document.createElement('a');
zebra.href = '#c_inputDiv';
function openReply(id) {
    ...
    zebra.click(); // Jump to the space to type
}
